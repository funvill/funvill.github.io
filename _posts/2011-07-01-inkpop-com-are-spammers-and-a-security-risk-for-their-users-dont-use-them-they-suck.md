...
<ol>
	...
	<li>A smiley face emoticon in what I guess you where trying to pass off as aÂ semi-professional pitch? What are you twelve?</li>
	<li>I hate spammers and this is email is spam. I go out of my way to make it as hard (posts like this)Â andÂ expensiveÂ asÂ possibleÂ for spammers like this to operate.</li>
	<li>We have a system set up for<a href="http://www.everydayfiction.com/features/help-us/advertise-with-us/"> sponsorship</a> that would let them get a link on the site toÂ theirÂ site. The correct way toÂ advertise on a magazine, but that costs money and supports our magazine and they want it for free.</li>
</ol>
...
<strong>They are a security risk for you and yourÂ children </strong>
...
<ol>
	<li>They are storing YOUR password as plain text in their database. This is really bad and there is no need for it. If their web servers are compromisedÂ then the hackers will have access to your password and personal information that they can use to try and attack other sites you are registered with. See this post for more informationÂ <a href="http://www.abluestar.com/blog/a-perfect-example-of-why-you-should-use-the-same-password-on-different-websites/">A perfect example of why you should use the same password on different websites.</a></li>
...
InkPop.com isÂ dangerous.

<strong>ThereÂ initialÂ email </strong>
