...
When the [COVID-19](https://en.wikipedia.org/wiki/Coronavirus_disease_2019) lockdown started in March of 2020, my office closed down.  We started Working From Home (WFH). Because of this, I no longer had a commute.  I rarely left the house for the first few weeks. My daily commute, walk to work was the primary way I got exercise each day. Lack of daily exercise, the same four walls every day, and general stress of COVID were causing me to be mildly depressed. My partner suggested we start taking walks after work around the neighborhood and a local park near my house. After a few weeks, we got tired of walking around the same park and the same streets every day. My partner suggested that we go to all the different parks in Vancouver for exercise, a COVID-19 project, and to get to know all the different neighborhoods in Vancouver. A quick google showed that there were [~250 parks](https://vancouver.ca/parks-recreation-culture/parks-gardens-and-beaches.aspx) and if we went to a couple a day we could see them all before the end of the year. With lots of parks on bike paths, we could potentially see a dozen or so parks on a single ride. As a way of checking off the parks, we decided to do a selfie in front of each of the park signs and post it to social media. It took us seven and a half months, we completed this project and visited our last park on December 19th, 2020.
...
- [Fraser River Park[](](https://covapp.vancouver.ca/parkfinder/parkdetail.aspx?inparkid=92)) - Walk along the river on a boardwalk, see the dogs playing in the off-leash section and a fantastic view of airplanes landing. A great place for recording slow TV.
...
- **New Park** - An Italian-style park that just seems out of place in the city but is filled with wonderful garden beds, art, and a labyrinth.
- [Crab Park](https://covapp.vancouver.ca/ParkFinder/parkdetail.aspx?inparkid=28) - Great view of the north shore, sea bus, Harbor air helicopters landing, a good place for a picnic, and all the boats in the Vancouver harbor.
- [Marpole Midden](https://covapp.vancouver.ca/parkfinder/parkdetail.aspx?inparkid=124) - A plain open field park, but the history of this place was really interesting. A [National Historic Site of Canada](https://www.pc.gc.ca/apps/dfhd/page_nhs_eng.aspx?id=81)
...
- [Jonathan Rogers Park](https://covapp.vancouver.ca/ParkFinder/ParkDetail.aspx?InParkId=137) - Good views, a great place for a beer.
...
When I started this project I created a spreadsheet of all the parks, sorted the spreadsheet by neighborhood, and tried to visit the parks based on neighborhoods. This worked, but I found it better to just create a google map of all parks across the city and check them off as I visited them. The map allowed optimistic viewing of the parks. If I was driving somewhere to pick up something I checked my route to see if there were any parks nearby, we took a detour to check them out. This had the nice benefit of making almost all trips outside of the house part of the parks project.
