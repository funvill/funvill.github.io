...
When I started this project I created a spreadsheet of all the parks, sorted the spreadsheet by neighborhood, and tried to visit the parks based on neighborhoods. This worked, but I found it better to just create a google map of all parks across the city and check them off as I visited them. The map allowed spontanious viewing of the parks. If I was driving somewhere to pick up something I checked my route to see if there were any parks nearby, I took a detour to check them out. This had the nice benefit of making almost all trips outside of the house part of the parks project.
